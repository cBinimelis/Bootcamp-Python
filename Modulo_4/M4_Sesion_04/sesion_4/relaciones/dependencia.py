...
# En el contexto de una Clínica y Pacientes. La clase Clínica depende de la clase
# Paciente para poder registrar y gestionar citas médicas.
...
class Paciente:
    ...
    def update_motivo(self, nuevo_motivo):
        ...
        print(
            f"El motivo de la consulta de: {self.nombre}, ha cambiado a: {self.motivo_consulta}"
        )
