...
# En el contexto de una Universidad que contiene Departamentos. Cada Departamento
# tiene a su vez Profesores. Aquí, la clase Universidad está compuesta por varias
# instancias de Departamento, y la clase Departamento está compuesta por varias
# instancias de Profesor.

# + Si se destruye una instancia de la clase Universidad, se destruyen también
# los departamentos que contiene.
...
class Universidad:
    ...
    def show_departamentos_list(self):
        print(
            f"La universidad, {self.nombre_universidad}, tiene los siguentes departamentos"
        )
