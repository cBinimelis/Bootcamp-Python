...
# Una Orquesta tiene muchos músicos, pero si se destruye la orquesta,
# los músicos seguirán existiendo y podrán unirse a otras orquestas.
...
class Musico:
    ...
    def tocar(self):
        print(
            f"El musico {self.nombre}, esta tocando el instrumento: {self.instrumento}"
        )
